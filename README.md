...
```text
/hacsfiles/lovelace-boiler-card/lovelace-boiler-card.js?v=0.5.0
```
...
Version 0.5.0 uses the approved no-text SVG layout as the visual baseline. Values and labels can now be reintroduced incrementally.
