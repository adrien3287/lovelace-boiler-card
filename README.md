...
```text
/hacsfiles/lovelace-boiler-card/lovelace-boiler-card.js?v=0.5.1
```
...
Version 0.5.1 uses the approved no-text SVG layout as the visual baseline. Values and labels can now be reintroduced incrementally.
