...
## v0.6.16 clean dynamic oil level

- introduces a new dedicated oil-level renderer rather than reusing the previous rectangle/mask logic,
- uses `oil_height_percent` exclusively for the visible liquid height,
- keeps displayed `%` from `oil_level` and litres from `oil_volume`,
